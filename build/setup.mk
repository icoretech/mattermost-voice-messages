...
BUILD_HASH_SHORT = $(shell git rev-parse --short HEAD 2>/dev/null || true)
BUILD_TAG_LATEST = $(shell git describe --tags --match 'v*' --abbrev=0 2>/dev/null || true)
BUILD_TAG_CURRENT = $(shell git tag --points-at HEAD 2>/dev/null || true)
